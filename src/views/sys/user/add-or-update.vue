			...
			<el-row>
				<el-col :span="12">
					...
					<el-form-item prop="orgId" label="所属机构">
						...
						<el-select v-model="dataForm.orgId" placeholder="店铺" style="width: 100%"
							>
					...
					<el-form-item prop="postIdList" label="所属岗位">
						<el-select v-model="dataForm.postIdList" multiple placeholder="所属岗位" style="width: 100%">
							<el-option v-for="post in postList" :key="post.id" :label="post.postName"
								:value="post.id"></el-option>
						</el-select>
					</el-form-item>
				</el-col>
