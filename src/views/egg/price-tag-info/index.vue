<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			<el-form-item prop="name">
				<el-input v-model="state.queryForm.name" placeholder="电子价签名称"></el-input>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table"
			...
			<el-table-column prop="name" label="电子价签名称" header-align="center" align="center"></el-table-column>
			<el-table-column label="电子价签图片" header-align="center" align="center" width="500">
...
<script setup lang="ts" name="EggPrice-tag-infoIndex">
...
const state: IHooksOptions = reactive({
	dataListUrl: '/price-tag/info/page',
	deleteUrl: '/price-tag/info',
	queryForm: {
		name: ''
	}
})
